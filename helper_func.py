...
from config import FORCE_SUB_CHANNEL, ADMINS, FORCE_SUB_CHANNEL_2,FORCE_SUB_CHANNEL_3
...
subscribed1 = filters.create(is_subscribed)
subscribed2 = filters.create(is_subscribed2)
subscribed4 = filters.create(is_subscribed3)
